    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 2) {
                    as.switchToStats(ThreeActivity.this);
                } else if (position == 1) {
                    as.switchToMulti(ThreeActivity.this);
                } else if (position == 0) {
                    as.switchToSingle(ThreeActivity.this);
                }
            }
        });
    ...
    private void buttonLogic() {
        ...
        buttonOne.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                alert.threeplayerone(ThreeActivity.this);
            }
        });
        ...
        buttonTwo.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDlg alert = new AlertDlg();
                alert.threeplayertwo(ThreeActivity.this);
            }
        });
        ...
        buttonThree.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDlg alert = new AlertDlg();
                alert.threeplayerthree(ThreeActivity.this);
            }
        });
